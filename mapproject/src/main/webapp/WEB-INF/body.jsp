...
<div class="body-container container-fluid">
	...
	<div class="row justify-content-center">
		...
		<!--=================== content 시작 ====================-->
		<div class="col-lg-10 col-md-9 col-12 align-content-center" style="margin-top: 2%">
			<div class="map_wrap">
...
<script>
 ...
 $.get("/pin/list", function(data) {   
     var markers = $(data.item).map(function(i, position) {
        ...
        infoContent.innerHTML = '위도 : ' + marker.getPosition().getLat() + ' 경도 : ' + marker.getPosition().getLng() + '<br>';
 ...
 function insertPin(positions){
   ...
   console.log(positions.getLat());
   console.log(positions.getLng());
   ...
   ({
      ...
      data: JSON.stringify({
         ...
         pmemo: "test...",
         ptheme:"blue2",
         pinLat: positions.getLat(),
         pinLng: positions.getLng(),
         rate:"1"
      }),
